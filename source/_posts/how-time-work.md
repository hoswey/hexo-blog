...
连"获取时间“都要优化，nginx不就是这么处理么？为什么要这样处理?时间这个基础性的信息底层到底是怎样呢，而高级语言Java/C这些获取时间的方式又是怎么和底层交互的？这个问题激起了我极大的想去，希望能通过对“时间”的技术细节做层梳理和探索，加深对操作系统以及Java语言的理解。以生产环境服务器ubuntu为例，设定以下目标
